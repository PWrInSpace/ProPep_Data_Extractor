...
The ProPep output file should be saved as <i>"data.txt"</i> and placed in the same folder as the <i>.exe</i> file. The result of the script running is generated as a <i>output.csv</i> file in the same directory.
